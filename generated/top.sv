...
module top(	// src/main/scala/Main.scala:22:7
  ...
  output [31:0] io_curPC,	// src/main/scala/Main.scala:23:20
                io_nextPC	// src/main/scala/Main.scala:23:20
);

  wire [31:0] _exu_io_nextPC;	// src/main/scala/Main.scala:33:49
  ...
  PC pc (	// src/main/scala/Main.scala:29:49
    ...
    .io_dnpc     (_exu_io_nextPC),	// src/main/scala/Main.scala:33:49
    .io_pc       (_pc_io_pc)
  );
  ...
  assign io_curPC = _pc_io_pc;	// src/main/scala/Main.scala:22:7, :29:49
  assign io_nextPC = _exu_io_nextPC;	// src/main/scala/Main.scala:22:7, :33:49
endmodule
